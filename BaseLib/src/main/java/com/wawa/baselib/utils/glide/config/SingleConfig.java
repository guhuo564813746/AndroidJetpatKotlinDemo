package com.wawa.baselib.utils.glide.config;
...
public class SingleConfig {
    ...
    private RoundedCornersTransformation.CornerType rectRoundRadiusType;//圆角类型
//    RoundedCornersTransformation.CornerType.BOTTOM_LEFT
    ...
    public SingleConfig(ConfigBuilder builder) {
        ...
        if (shapeMode == ShapeMode.RECT_ROUND) {
            ...
            this.rectRoundRadiusType=builder.rectRoundRadiusType;
        }
    ...
    public RoundedCornersTransformation.CornerType getRectRoundRadiusType(){
        return rectRoundRadiusType;
    }
    ...
    public static class ConfigBuilder {
        ...
        private int shapeMode;//默认矩形,可选直角矩形,圆形/椭圆
        private int rectRoundRadius;//圆角矩形时圆角的半径
        private RoundedCornersTransformation.CornerType rectRoundRadiusType;
         ...
         * @return
         */
        public ConfigBuilder rectRoundCorner(int rectRoundRadius,RoundedCornersTransformation.CornerType rectRoundRadiusType) {
            this.rectRoundRadiusType=rectRoundRadiusType;
